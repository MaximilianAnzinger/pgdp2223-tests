...
class OfficialExampleTests {
    ...
    @Test
    void averageDelayAt() {
        assertEquals(10.0, DataProcessing.averageDelayAt(trainConnections.stream(), Station.NUERNBERG_HBF));
    }
    ...
    void averageDelayByHour() {
        ...
        assertEquals(0.0, actual.get(10));
        assertEquals(0.0, actual.get(11));
        assertEquals(15.0, actual.get(12));
        assertEquals(20.0, actual.get(13));
