...
public class PinguNetworkTest {
    @Test
    @DisplayName("User - Create a user with no profile picture")
    public void testUser1(){
        User bob = new User("Bob", "i code stuff");
        assert(bob.getName().equals("Bob"));
        assert(bob.getDescription().equals("i code stuff"));
        assert(bob.getProfilePicture() == null);
    }
    ...
    public void testUser3(){
        User bob = new User("Bob", "i code stuff");
        User alice = new User("Alice", "lol");
        User joe = new User("Joe", "jell-o is tasty");
