...
public class GenerateModelTest {
    ...
    @Test
    public void emptyProcrastinators() {
        int[] workaholics = {1, 2, 3};
        int[] procrastinators = {};
        int[][] friendships = {};
        FlowGraph graph = PenguSurvivors.generateModel(workaholics, procrastinators, friendships);
    ...
    @Test
    public void nullWorkaholics() {
        int[] workaholics = null;
        int[] procrastinators = {1, 2, 3};
        int[][] friendships = {};
        FlowGraph graph = PenguSurvivors.generateModel(workaholics, procrastinators, friendships);
        if (graph != null) {
    ...
    @Test
    public void nullProcrastinators() {
        int[] workaholics = {1, 2, 3};
        int[] procrastinators = null;
        int[][] friendships = {};
        FlowGraph graph = PenguSurvivors.generateModel(workaholics, procrastinators, friendships);
        if (graph != null) {
            int maxPairs = graph.computeMaxFlowValue();
    ...
    @Test
    public void friendshipOutOfBounds() {
        int[] workaholics = {1, 2, 3};
        int[] procrastinators = {1, 2, 3};
        int[][] friendships = {{0, 5},{5, 0}};
        FlowGraph graph = PenguSurvivors.generateModel(workaholics, procrastinators, friendships);
        int maxPairs = graph.computeMaxFlowValue();
        assertEquals(0, maxPairs);
    }
